...
const gcc = [
  {
    ...
    width: 480,
    height: 480,
    src: "/_app/immutable/assets/google-cybersecurity-certificate.2b357b56.avif"
  },
  {
    format: "webp",
    width: 480,
    height: 480,
    src: "/_app/immutable/assets/google-cybersecurity-certificate.d0660f43.webp"
  },
  {
    format: "jpg",
    width: 480,
    height: 480,
    src: "/_app/immutable/assets/google-cybersecurity-certificate.cf042380.jpg"
  },
  {
    format: "avif",
    width: 1024,
    height: 1024,
    src: "/_app/immutable/assets/google-cybersecurity-certificate.6ad50dfa.avif"
  },
  {
    format: "webp",
    width: 1024,
    height: 1024,
    src: "/_app/immutable/assets/google-cybersecurity-certificate.95fe2ab1.webp"
  },
  {
    format: "jpg",
    width: 1024,
    height: 1024,
    src: "/_app/immutable/assets/google-cybersecurity-certificate.28a96585.jpg"
  },
  {
    format: "avif",
    width: 1920,
    height: 1920,
    src: "/_app/immutable/assets/google-cybersecurity-certificate.a2672e4f.avif"
  },
  {
    format: "webp",
    width: 1920,
    height: 1920,
    src: "/_app/immutable/assets/google-cybersecurity-certificate.667db62e.webp"
  },
  {
    format: "jpg",
    width: 1920,
    height: 1920,
    src: "/_app/immutable/assets/google-cybersecurity-certificate.0a3b573b.jpg"
  },
  {
    format: "webp",
    width: 16,
    height: 16,
    base64: "data:image/webp;base64,",
    src: "/_app/immutable/assets/google-cybersecurity-certificate.309f8223.webp"
  }
];
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="bg-slate-900"><section class="flex flex-col md:flex-row px-8 md:px-24 py-8 items-center md:items-start"><div>${validate_component(SvelteImg, "Img").$$render(
    $$result,
    {
      class: "w-40 rounded-full max-w-xs flex-row",
      src: michal,
      alt: "Michał Maciak"
    },
    {},
    {}
            ...
            <div class="px-2 md:px-4"><a href="https://www.credly.com/badges/28200b0e-8527-4627-9f03-75f2c6c368c8/public_url">${validate_component(SvelteImg, "Img").$$render(
    $$result,
    {
      class: "w-40 md:w-48",
      src: gcc,
    ...
    {}
        ...
        <div class="flex flex-row justify-center items-start md:justify-end w-full md:w-5/6 pt-8 md:pt-0"><div class="px-2 md:px-4 hover:animate-bounce"><a href="https://github.com/MichalMaciak">${validate_component(SvelteImg, "Img").$$render(
    $$result,
    {
      class: "w-20 md:w-12",
      src: github,
    ...
    {}
            ...
            <div class="px-2 md:px-4 hover:animate-bounce"><a href="mailto:michal@maciak.dev">${validate_component(SvelteImg, "Img").$$render(
    $$result,
    {
      class: "w-20  md:w-12",
      src: mail,
    ...
    {}
            ...
            <div class="px-2 md:px-4 hover:animate-bounce"><a href="tel:+48793433348">${validate_component(SvelteImg, "Img").$$render(
    $$result,
    {
      class: "w-20 md:w-12",
      src: phone,
...
<main class="bg-slate-900"><section class="flex flex-col justify-center items-center pb-10"><h2 class="text-teal-100 text-4xl md:text-5xl my-12 px-8 font-sans">&quot;The cobbler&#39;s children have no shoes&quot;</h2>  
      <h1 class="text-6xl mx-32 md:text-9xl md:mx-72 text-teal-400 text-right font-bold font-serif tracking-wider mb-10">I solve <span class="underline">Your</span> problems
        ...
        <div class="flex flex-col md:flex-row md:py-12 "><div class="px-14 py-8 md:py-0"><h3 class="text-teal-100 text-3xl font-sans border-l-2 border-teal-100 pl-4">websites, speed and functionality issues</h3></div>
            ...
            <div class="px-14 py-8 md:py-0"><h3 class="text-teal-100 text-3xl font-sans border-l-2 border-teal-100 pl-4">cybersecurity, network security, cybersecurity assessment</h3></div></div></section></main>
